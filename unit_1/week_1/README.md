...
Team Treehouse delivers content through courses, tracks and achievements. A course and track is comprised of a number of achievements. During phase-0, you will be asked to either complete a particular achievement or complete a complete course. 

## To-Do:

1. Complete steps 1-12 in "Getting Started with the Console" Achievement in Treehouse's [Console Foundations ](http://teamtreehouse.com/library/console-foundations) Course. 
