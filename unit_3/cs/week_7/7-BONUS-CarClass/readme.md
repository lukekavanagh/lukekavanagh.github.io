...
In this challenge, we're going to tackle the trickier task of creating a class with only user stories by taking a real world object and translating it to working code.
...
## Release 0: [Pseudocode](https://github.com/weka-2014/phase-0-handbook/blob/master/coding-references/pseudocode.md)
...
## Release 1: Write [Driver Code](https://github.com/weka-2014/phase-0-handbook/blob/master/coding-references/driver-code.md) 
...
## Release 5: [Refactor](https://github.com/weka-2014/phase-0-handbook/blob/master/coding-references/refactoring.md) your code!

## Release 6: [Reflect](https://github.com/weka-2014/phase-0-handbook/blob/master/coding-references/reflection-guidelines.md)
